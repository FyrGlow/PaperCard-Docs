<template><div><!-- more -->
<h2 id="正确回答下面的问题即可获得服务器地址" tabindex="-1"><a class="header-anchor" href="#正确回答下面的问题即可获得服务器地址"><span><strong>正确回答下面的问题即可获得服务器地址</strong></span></a></h2>
<div class="hint-container tip">
<p class="hint-container-title">请注意</p>
<ul>
<li><strong>本页内容非应试考题，而是旨在为新入服玩家提到引导作用！</strong></li>
<li><strong>起码你在做完这些题目后知道出了问题应该怎么做以及了解服务器。</strong></li>
</ul>
</div>
<div id="quiz">
...
<p><button class="submit-button" onclick="checkAnswers()">提交答案</button></p>
  <div id="result1"></div>
</div>
</div></template>

...
function showHelp() {
	...
	$("#inst_main_body").html("<div id='instructions_head'>游戏玩法</div><p>Hextris 的玩法类似于消消乐。</p><p>" + (settings.platform != 'mobile' ? '按下左箭头或右箭头' : '点击屏幕的左右两侧') + "来旋转六边形。" + (settings.platform != 'mobile' ? ' <br>按下箭头来加速方块下落': '') + " </p><p>通过使 3 个或更多相同颜色的方块接触来清除方块并获得分数。</p><p>连击获得更多分数，连击由边框<span style='color:#f1c40f;'>彩色</span><span style='color:#e74c3c'>线条</span><span style='color:#3498db'>提示</span><span style='color:#2ecc71'>。</span></p> ");
	if (gameState == 1) {
		pause();
	}

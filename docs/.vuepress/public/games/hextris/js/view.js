...
function showText(text) {
	var messages = {
		"paused": "<div class='centeredHeader unselectable'>游戏已暂停</div><br><br><a class='button' href='/news/game.html'>返回纸片小游戏列表</a>",
		'pausedAndroid': "<div class='centeredHeader unselectable'>游戏已暂停</div><br><br><a class='button' href='/news/game.html'>返回纸片小游戏列表</a>",
		'pausediOS': "<div class='centeredHeader unselectable'>游戏已暂停</div><br><br><a class='button' href='/news/game.html'>返回纸片小游戏列表</a>",
		'pausedOther': "<div class='centeredHeader unselectable'>游戏已暂停</div><br><br><a class='button' href='/news/game.html'>返回纸片小游戏列表</a>",
		'start': "<div class='centeredHeader unselectable' style='line-height:80px;'>按 Enter 键开始游戏</div>"
	};
